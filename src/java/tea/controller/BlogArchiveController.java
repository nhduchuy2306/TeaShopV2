 ...
 * @author Huy
 */
@WebServlet(name = "BlogArchiveController", urlPatterns = {"/BlogArchiveController"})
public class BlogArchiveController extends HttpServlet {

    private static final String ERROR = "/client/404.jsp";
    private static final String SUCCESS = "/client/blog-archive.jsp";
