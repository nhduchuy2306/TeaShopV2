 ...
 * @author Huy
 */
@WebServlet(name = "RemoveAdminController", urlPatterns = {"/RemoveAdminUserController"})
public class RemoveAdminUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(user.getUserID().equals(uID)){
                request.setAttribute("ERROR", "CAN'T DELETE CURRENT USER");
            }
            else{
                boolean check = userDAO.delete(uID);
                if(check){
